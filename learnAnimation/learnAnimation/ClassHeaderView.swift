...
class ClassHeaderView: CustomHeaderFooterView {
    ...
    func normalStateAnimated(_ animated : Bool){
        ...
        UIView.animate(withDuration: true ? 0.5 : 0, delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 0, options: .allowUserInteraction, animations: { 
            ...
            self.highClassNameLabel.frame = CGRect(x: 10, y: 0, width: 100, height: 25)
        }, completion: nil)
