...
class TapCellAnimationController: NormalTitleViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func setup() {
        ...
        func addText(_ string : String){
            ...
            datas.append(ShowTextCell.Adapter( data: model, cellHeight: ShowTextCell.HeightWithData(model), type: EShowTextCellType.normalType.rawValue))
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueCellAndLoadContentFromAdapter(datas[(indexPath as NSIndexPath).row], indexPath: indexPath, tableView: tableView)
